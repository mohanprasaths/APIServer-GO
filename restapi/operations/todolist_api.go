...
type TodolistAPI struct {
	...
	// JSONConsumer registers a consumer for a "application/todo.json" mime type
	JSONConsumer runtime.Consumer

	// JSONProducer registers a producer for a "application/todo.json" mime type
...
func (o *TodolistAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/todo.json":
			result["application/todo.json"] = o.JSONConsumer
...
func (o *TodolistAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/todo.json":
			result["application/todo.json"] = o.JSONProducer
